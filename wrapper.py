    ...
    def __init__(self):
        ...
        while(True):
            ...
            if not use_pointcloud:
                ...
                map_depth = self.squeeze.quantilize(squeezed_matrix, n_sec=num_section, max_per_occ=max_per_occ)
            else:

                map_depth, target, facing_wall = pipeline(pointcloud, row = num_slice, col = num_section, row_size = 6, col_size = 10, show=False)
