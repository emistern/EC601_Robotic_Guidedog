...
input_image_file= './512_Monitor.jpg'
tiny_yolo_graph_file= '/home/yxiao1996/workspace/EC601_Robotic_Guidedog/catkin_ws/src/rosyolo/src/graph'
...
class YoloDetector():
    ...
    def getImage(self, input_image_file):
...
if __name__ == "__main__":
    #sys.exit(main())
    d = YoloDetector()
    input_img, disp_img = d.getImage('./512_Monitor.jpg')
    objs = d.detect(input_img)
    d.displayDetection(disp_img, objs)
    d.onShutdown()
